...
# ------------------------------------------------------------------------------------------ add -----------------------------------------------------------------------------------
    ...
    event_name=[
        ...
        app_commands.Choice(name= 'Datathon', value = 'DATATHON'),
        app_commands.Choice(name= 'Hack-in', value = 'HACK-IN'),
        app_commands.Choice(name= 'Last Stand-nfs', value = 'LASTSTAND-NFS'),
        app_commands.Choice(name= 'Last Stand-valorant', value = 'LASTSTAND-VALORANT'),
        app_commands.Choice(name= 'Triple Trouble', value = 'TRIPLE-TROUBLE'),
        app_commands.Choice(name= 'Math Pirates', value = 'MATH PIRATES'),
        app_commands.Choice(name= 'Reverse Coding', value = 'REVERSE CODING'),
        app_commands.Choice(name= 'InQuizitives', value = 'INQUIZITIVES'),
        app_commands.Choice(name= 'Artistry', value = 'ARTISTRY'),
        app_commands.Choice(name= 'Code Sprint', value = 'CODESPRINT'),
        ...
        app_commands.Choice(name= 'Fractal Fanatics', value = 'FRACTAL FANATIC'),
        app_commands.Choice(name= 'Invenirer', value = 'INVENIRER'),
        app_commands.Choice(name= 'Nethunt', value = 'NETHUNT'),
        app_commands.Choice(name= 'Techiadz', value = 'TECHIADZ'),
        app_commands.Choice(name= 'Star of Login', value = 'STAR OF LOGIN'),
        app_commands.Choice(name= 'Thinklytics', value = 'THINKLYTICS')
        ]
    ) 
    async def add_results(self, interaction: discord.Interaction,event_name: app_commands.Choice[str], participant_email: str, position: app_commands.Choice[str]):
